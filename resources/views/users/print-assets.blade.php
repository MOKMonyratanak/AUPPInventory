...
<body>
    ...
    <div class="section-break center underline">COMPANY ISSUED DEVICES FORM</div>
    ...
    <div class="signature-line">
        <table class="table-borderless">
            ...
            <tr>
                <td>Name: <span class="underline">______________________</span></td>
                <td>Name: <span class="underline">______________________</span></td>
            </tr>
            <tr>
    ...
    <div class="center">
        <span class="bold">Note:</span> Only full-time staff and faculty will be issued laptops and other equipment. <br><br>
    </div>
    <div class="left">
        Check-in Date: ________________    Signature of Faculty/Staff: _________________
    </div>
